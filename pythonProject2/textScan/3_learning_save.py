...
train_data = data_load('ratings_train_min_30000.txt')
test_data = data_load('ratings_test_min_20000.txt')
...
selected_words = [f[0] for f in text.vocab().most_common(10000)] # 데이터 사이즈에 따라 증감, 원래 10000
...
model.add(layers.Dense(64, activation='relu', input_shape=(10000,))) # input_shape는 데이터 사이즈에 따라 증감, 원래 10000
