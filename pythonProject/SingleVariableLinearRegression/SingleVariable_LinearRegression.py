...
# 훈련용 데이터 수 선언
trainDataNumber = 100
# 모델 최적화를 위한 학습률 선언 - 데이터가 클 수록 학습률이 작아저야한다?
learningRate = 0.005
# 총 학습 횟수 선언 - 데이터 개수를 초과하면 추이를 따르는 임의의 데이터를 만들어서 돌린다?
totalStep = 51
...
# 최종값 : Train cost : 10192097.0, W : [1873.5303], b : [-38.5791] / learningRate = 0.0001 / totalStep = 약 120000
xTrainData = [2.2, 3.1, 15.4, 7.6, 11, 9.2, 3.4, 13.7, 4.5, 10, 2, 1.5, 1, 3, 4, 5, 8.5, 12, 18, 2.5, 2, 1.5, 10, 5, 20,
